...
const dbName = process.env.DB_NAME || "fake_store";
const dbPort = process.env.DB_PORT || "27017";

const DATABASE_URL = `mongodb://${dbUser}:${dbPass}@${dbHost}:${dbPort}/${dbName}?authSource=admin`;
...
const products = [
  ...
  },
  {
    ...
    price: 599,
    description:
      "21.5 inches Full HD (1920 x 1080) widescreen IPS display And Radeon free Sync technology. No compatibility for VESA Mount Refresh Rate: 75Hz - Using HDMI port Zero-frame design | ultra-thin | 4ms response time | IPS panel Aspect ratio - 16: 9. Color Supported - 16.7 million colors. Brightness - 250 nit Tilt angle -5 degree to 15 degree. Horizontal viewing angle-178 degree. Vertical viewing angle-178 degree",
    category: "electronics",
...
async function seedDatabase() {
  try {
    ...
    console.log("\n🎉 You can now test:");
    console.log("   GET  http://localhost/products");
    console.log("   GET  http://localhost/users");
    console.log("   GET  http://localhost/carts");
